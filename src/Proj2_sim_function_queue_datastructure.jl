# Basic sim function from Unit 6 notes using queue data structure - NEED TO EDIT/CHANGE #####################################################
# consider queue data structure like this one for individual queues, and a minbinaryheap data structure for the park as a whole?
